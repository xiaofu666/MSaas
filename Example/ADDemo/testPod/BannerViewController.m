...
- (void)bannerBtnClicked:(UIButton*)button{
    ...
    //根据宽高比自定义适配
    CGFloat height = 60;
    self.bannerView = [[UIView alloc]initWithFrame:CGRectMake(0,SF_ScreenH-height-[UIApplication sharedApplication].keyWindow.safeAreaInsets.bottom, width, height)];
